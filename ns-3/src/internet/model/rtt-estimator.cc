...
RttEstimator::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RttEstimator")
    ...
    .AddAttribute ("MinRTO", 
                   ...
                   TimeValue (Seconds (0.12)), // RFC2988 says min RTO=1 sec, but Linux uses 200ms. See http://www.postel.org/pipermail/end2end-interest/2004-November/004402.html
...
void RttEstimator::IncrNext (SequenceNumber32 seq, uint32_t size)
{
