...
public:
	...
	/**
	 * @brief Class representing AdditionalInfo section of the content object
	 * [MT]
	 */
	class AdditionalInfo
	{
	   ...
	   */
	  void
	  SetHopCount (const uint32_t count);
	  ...
	  private:
	    uint32_t m_hopCount;
	    //uint32_t m_nodeID;        // **[MT]** Not necessary if nodes don't exchange BF updates
  ...
  /**
   * @brief Get editable reference to content object's AdditionalInfo
   */
  inline AdditionalInfo &
  GetAdditionalInfo ();

  /**
   * @brief Get read-only reference to content object's AdditionalInfo
   */
  inline const AdditionalInfo &
  GetAdditionalInfo () const;
...
ContentObject::AdditionalInfo &
ContentObject::GetAdditionalInfo ()
{
  return m_additionalInfo;
}

const ContentObject::AdditionalInfo &
ContentObject::GetAdditionalInfo () const
{
  return m_additionalInfo;
}
