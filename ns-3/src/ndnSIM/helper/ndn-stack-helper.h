...
public:
  ...
  /**
   * @brief Set repository class and its attributes
   * @param repositoryClass string, representing class of the repository
   * [MT]
   */
  void
  SetRepository (const std::string &repositoryClass,
                 const std::string &attr1 = "", const std::string &value1 = "",
                 const std::string &attr2 = "", const std::string &value2 = "",
                 const std::string &attr3 = "", const std::string &value3 = "",
                 const std::string &attr4 = "", const std::string &value4 = "");
  ...
  /**
   * @brief Set bloom-filter class and its attributes
   * @param bloomFilterClass string, representing class of the bloom-filter
   * [MT]
   */
  void
  SetBfFib (const std::string &BfClass,
         const std::string &attr1 = "", const std::string &value1 = "",
         const std::string &attr2 = "", const std::string &value2 = "",
         const std::string &attr3 = "", const std::string &value3 = "",
         const std::string &attr4 = "", const std::string &value4 = "",
  ...
  void
  SetBfCache (const std::string &BfClass,
         const std::string &attr1 = "", const std::string &value1 = "",
         const std::string &attr2 = "", const std::string &value2 = "",
         const std::string &attr3 = "", const std::string &value3 = "",
         const std::string &attr4 = "", const std::string &value4 = "",
...
private:
  ...
  ObjectFactory m_repoFactory;
  ObjectFactory m_pitFactory;
  ObjectFactory m_fibFactory;
  ObjectFactory m_bfFibFactory;
  ObjectFactory m_bfCacheFactory;
