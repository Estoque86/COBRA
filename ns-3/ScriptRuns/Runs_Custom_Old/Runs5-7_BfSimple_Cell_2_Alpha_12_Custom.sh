...
./waf --run "scratch/bloom-filter-routing-scenario --valoreAlpha=12 --contentCatalogFib=104450 --desiredPfpFib=0.05 --cellWidthBfFib=2 --bfScope=fib --bfTypeFib=simple --bfFibInitMethod=custom --cacheToCatalog=0.003 --customLengthBfFib=325634 --customHashesBfFib=2 --simType=3 --ns3::ndn::ConsumerCbr::Randomize=uniform --ns3::ndn::Consumer::LifeTime=2s --ns3::ndn::Consumer::RetxTimer=25ms --RngRun=6 --RngSeed=1" > ${PATHLOG}/log6_BfSimple_Cell_2_Alpha_12.out 2>&1
...
./waf --run "scratch/bloom-filter-routing-scenario --valoreAlpha=12 --contentCatalogFib=104450 --desiredPfpFib=0.05 --cellWidthBfFib=2 --bfScope=fib --bfTypeFib=simple --bfFibInitMethod=custom --cacheToCatalog=0.003 --customLengthBfFib=325634 --customHashesBfFib=2 --simType=3 --ns3::ndn::ConsumerCbr::Randomize=uniform --ns3::ndn::Consumer::LifeTime=2s --ns3::ndn::Consumer::RetxTimer=25ms --RngRun=7 --RngSeed=1" > ${PATHLOG}/log7_BfSimple_Cell_2_Alpha_12.out 2>&1
